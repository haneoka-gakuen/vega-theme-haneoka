...
const ICON_PATHS: Readonly<Record<HaneokaIconName, readonly string[]>> = Object.freeze({
  ...
  flow: ["M7 5h10v4H7z", "M4 15h7v4H4z", "M13 15h7v4h-7z", "M12 9v3m-4 0h8m-8 0v3m8-3v3"],
  ...
  subtitles: ["M4 5h16v12H9l-5 3z", "M7 9h4", "M13 9h4", "M7 13h3", "M12 13h5"],
});

export const createHaneokaIcon = (document: Document, name: HaneokaIconName): SVGSVGElement => {
